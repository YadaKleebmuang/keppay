        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 rounded-xl border border-border bg-card p-4">
            ...
            <div className="mt-3 space-y-1.5">
              <DemoLink to="/dashboard" label="แดชบอร์ดสมาชิก" />
              <DemoLink to="/admin" label="แดชบอร์ดผู้ดูแล" />
              <DemoLink to="/pending" label="หน้ารออนุมัติบัญชี" />
              <DemoLink to="/disabled" label="หน้าบัญชีถูกระงับ" />
            </div>
          </div>
...
function GoogleMark() {
  return (
    <svg viewBox="0 0 24 24" className="size-4" aria-hidden="true">
      ...
      />
      <path fill="#FBBC05" d="M5.1 14.3c-.3-.8-.4-1.6-.4-2.3s.1-1.6.4-2.3V6.5H1.2A11.9 11.9 0 0 0 0 12c0 1.9.5 3.8 1.2 5.5l3.9-3.2Z" />
      <path
        fill="#EA4335"
